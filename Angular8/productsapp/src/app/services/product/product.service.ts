...
import { Department, Product } from 'src/app/interfaces';
...
export class ProductService {
  ...
  private productsSubject$: BehaviorSubject<Product[]> = new BehaviorSubject<Product[]>(null as unknown as Product[])
